# Prescription Example 03 - Bisoprolol (VOS) - Medication v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prescription Example 03 - Bisoprolol (VOS)**

## Example MedicationRequest: Prescription Example 03 - Bisoprolol (VOS)
...
```json
{
  ...
  "medicationCodeableConcept" : {
    "coding" : [{
      "system" : "urn:be:samv2:vmpgroup",
      "code" : "3889",
      "display" : "bisoprolol oraal 2,5 mg",
      "userSelected" : true
    }]
  },
  "subject" : {
