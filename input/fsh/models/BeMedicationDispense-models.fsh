...
* medicationLine 0..1 Reference(BeModelMedicationLine) "The medication line that this dispense is related to"
...
* recordedDate 1..1 dateTime "The date (or date+time) when the dispense was recorded"
...
* dispensedItem 0..* BackboneElement  "Each product that was dispensed"
  * product 0..1 CodeableConcept "The product that was dispensed - coded or not (e.g. for magistral preparations)"
