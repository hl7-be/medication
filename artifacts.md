...
| [Prescription Example 01 - Lasix](MedicationRequest-example-01-lasix.md) | Lasix 50 x 40 mg - Every other day (QOD) |
| [Prescription Example 02 - Hukyndra](MedicationRequest-example-02-hukyndra.md) | Hukyndra 6 x 40mg/0.4ml - Loading dose: week 0: 80mg, week 2: 40mg, then 40mg every 2 weeks |
| [Prescription Example 03 - Bisoprolol (VOS)](MedicationRequest-example-03-bisoprolol.md) | Bisoprolol tablets 2.5 mg - 1 x / day 2.5 mg for 3 months (VOS - Voorschrift Op Stofnaam) |
| [Prescription Example 04 - Gutron (Import)](MedicationRequest-example-04-gutron.md) | Gutron 5mg - Dose escalation: 2.5mg 3x/day for 1 week, then increase weekly by 2.5mg to 10mg 3x/day maintenance |
