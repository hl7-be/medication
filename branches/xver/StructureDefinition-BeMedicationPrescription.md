...
| Active as of 2026-03-12 | *Computable Name*:BeMedicationPrescription |
...
* Examples for this Profile: [MedicationRequest/GOFSH-GENERATED-ID-0](MedicationRequest-GOFSH-GENERATED-ID-0.md)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/medication/StructureDefinition/BasedOnMedicationLine"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/medication/StructureDefinition/BeExtInstructionsForReimbursement"]
      }],
      "mustSupport" : true
    },
    {
