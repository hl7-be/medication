...
| Active as of 2026-03-25 | *Computable Name*:BasedOnMedicationLine |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://www.ehealth.fgov.be/standards/fhir/medication/StructureDefinition/BeMedicationLine"]
      }]
    }]
  }
}
