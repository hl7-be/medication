# Prescription Example 02 - Hukyndra - Medication v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Prescription Example 02 - Hukyndra**

## Example MedicationRequest: Prescription Example 02 - Hukyndra
...
```json
{
  ...
  "medicationCodeableConcept" : {
    "coding" : [{
      ...
      "code" : "594755-01",
      "display" : "Hukyndra 40 mg inf. opl. s.c. voorgev. spuit 6 x 0.4 ml",
      "userSelected" : true
    }]
  },
  "subject" : {
