...
| Active as of 2026-04-04 | *Computable Name*:BeMedicationLine |
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-04-04T21:10:59+00:00",
  ...
  "differential" : {
    ...
    {
      "id" : "MedicationStatement.extension:adherence.extension:code.value[x]",
